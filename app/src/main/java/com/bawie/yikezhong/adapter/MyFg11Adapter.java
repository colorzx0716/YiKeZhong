...
public class MyFg11Adapter extends RecyclerView.Adapter<MyFg11Adapter.MyFg11ViewHolder>{
    ...
    public void onBindViewHolder(final MyFg11ViewHolder holder, int position) {
        ...
        boolean setUp = holder.fg32_player.setUp(videoUrl, JCVideoPlayer.SCREEN_LAYOUT_LIST, "");
        if (setUp) {
            Glide.with(context).load(icon).into(holder.fg32_player.thumbImageView);
        }
    ...
    class MyFg11ViewHolder extends RecyclerView.ViewHolder{
        ...
        private final JCVideoPlayerStandard fg32_player;
        ...
        public MyFg11ViewHolder(View itemView) {
            super(itemView);
            fg32_player = itemView.findViewById(R.id.fg11_player);
